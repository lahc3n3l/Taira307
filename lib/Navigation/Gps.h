...
public:
    ...
    void setLongitude(float longitude) { lng = longitude; }
    void setLatitude(float latitude) { lat = latitude; }
    void setAltitude(float altitude) { alt = altitude; }
    void setGroundSpeed(float speed) { groundSpeed = speed; }
    void setCourse(float course) { this->course = course; }
    void setHdop(float hdop) { this->hdop = hdop; } // horizontal dilution of precision (m)
public:
    GpsData() = default;
    private:
